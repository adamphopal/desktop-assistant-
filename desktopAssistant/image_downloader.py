...
#python image_downloader.py -s "Roses" -n 10
#or python image_downloader.py -s "Roses" -n 10 -d rose
...
def main():
    ...
    parser.add_argument('-d', '--directory', default='/desktopAssistant', type=str, help='save directory')
